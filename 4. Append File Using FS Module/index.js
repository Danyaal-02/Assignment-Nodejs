...
fs.appendFileSync('4. Append File Using FS Module/nodejs_architecture.txt',newData)
const readData=fs.readFileSync('4. Append File Using FS Module/nodejs_architecture.txt')
